...
void registration() {
    ...
    strcpy(bookedBus[usercount], "No ticket booked");
...
void cancelTicket(int userIndex) {
    if (ticketCount[userIndex] == 0) {
        printf("  You have no tickets to cancel.\n");
    } else {
        strcpy(bookedBus[userIndex], "No ticket booked");
